...
Future<Map<String, dynamic>> loadDb(bool acceptsDynamicTheme) async {
  ...
  Database db = await openDatabase(
    ...
    onCreate: (Database db, int version) async {
      ...
      await db.execute("CREATE TABLE appConfig (theme NUMERIC, overrideSslCheck NUMERIC, useDynamicColor NUMERIC, staticColor NUMERIC)");
      await db.execute("INSERT INTO appConfig (theme, overrideSslCheck, useDynamicColor, staticColor) VALUES (0, 0, ${acceptsDynamicTheme == true ? 1 : 0}, 0)");
    },
